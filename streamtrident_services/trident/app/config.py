...
class TridentConfig:
    ...
    benign_history_confidence_scale: float = 0.6
    ...
    increment_iforest_guard_min_samples: int = 20
...
def load_config(path: str | Path | None) -> TridentConfig:
    ...
    return TridentConfig(
        ...
        min_class_samples=int(payload.get("min_class_samples", 20)),
        ...
        increment_min_samples=int(payload.get("increment_min_samples", 20)),
        ...
        benign_history_confidence_scale=float(payload.get("benign_history_confidence_scale", 0.6)),
        ...
        increment_drift_min_history_samples=int(payload.get("increment_drift_min_history_samples", 50)),
        ...
        increment_route_min_samples=int(payload.get("increment_route_min_samples", 20)),
        ...
        increment_iforest_guard_min_samples=int(payload.get("increment_iforest_guard_min_samples", 20)),
