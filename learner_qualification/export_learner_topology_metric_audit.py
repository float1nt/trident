...
Usage:
  python3 learner_qualification/export_learner_topology_metric_audit.py outputs/runs/<run_id>
  python3 learner_qualification/export_learner_topology_metric_audit.py --raw-csvs cic2017/*.csv --label-csv labels.csv
"""
